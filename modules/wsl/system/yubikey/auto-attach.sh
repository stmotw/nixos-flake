...
# Vendored from: https://github.com/dorssel/usbipd-win/blob/v3.1.0/Usbipd/wsl-scripts/auto-attach.sh
# Original hash: sha256-KJ0tEuY+hDJbBQtJj8nSNk17FHqdpDWTpy9/DLqUFaM=
